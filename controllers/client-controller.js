...
class ClientController {
    ...
    try {
      ...
      if (!username && !email && !password && !repeatPassword) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.EMPTY')
        );
      }
      if (!/^[0-9a-zA-Z]+$/.test(username)) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.USERNAME.ERROR')
        );
      }
      if (!/^[^@]+@\w+(\.\w+)+\w$/.test(email)) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.EMAIL.ERROR')
        );
      }
      if (password !== repeatPassword) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.PASSWORD.NOT_MATCH')
        );
      }
      if (password.length < 4) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.PASSWORD.LONG')
        );
      }
      if (password.length > 32) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.PASSWORD.SHORT')
        );
      }
      ...
      if (isEmail) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.EMAIL.AVAILABLE')
        );
      }
      ...
      if (isUsername) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.REGISTRATION.USERNAME.AVAILABLE')
        );
      }
  ...
  async login(req, res, next) {
    try {
      ...
      if (!isPassEquals) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.LOGIN.NOT_MATCH_PASSWORD')
        );
      }
      const userDto = new UserDto(user);
  ...
  async sendNewActivationCode(req, res, next) {
    try {
      ...
      if (!tokenData) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.SEND_CODE.NOT_USER')
        );
      }
  ...
  async update(req, res, next) {
    try {
      ...
      if (!password) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.UPDATE.PASSWORD.EMPTY')
        );
      }
      if (email) {
        if (!/^[^@]+@\w+(\.\w+)+\w$/.test(email)) {
        ...
        if (email !== userData.email) {
          ...
          if (isEmail) {
            throw ApiError.BadRequerest(
              req.t('CONTROLLER.CLIENT.UPDATE.EMAIL.AVAILABLE')
            );
          }
        }
      }
      if (username) {
        ...
        if (username !== userData.username) {
          ...
          if (isUsername) {
            throw ApiError.BadRequerest(
              req.t('CONTROLLER.CLIENT.UPDATE.USERNAME.AVAILABLE')
            );
          }
        }
      }
      if (newPassword) {
        if (newPassword.length < 4) {
          throw ApiError.BadRequerest(
            req.t('CONTROLLER.CLIENT.UPDATE.PASSWORD.LONG')
          );
        }
        if (newPassword.length > 32) {
          throw ApiError.BadRequerest(
            req.t('CONTROLLER.CLIENT.UPDATE.PASSWORD.SHORT')
          );
        }
      }
      const tokenFromDb = await tokenService.get(refreshToken);
      ...
      if (!isPassEquals) {
        throw ApiError.BadRequerest(
          req.t('CONTROLLER.CLIENT.UPDATE.PASSWORD.NOT_MATCH')
        );
      }
